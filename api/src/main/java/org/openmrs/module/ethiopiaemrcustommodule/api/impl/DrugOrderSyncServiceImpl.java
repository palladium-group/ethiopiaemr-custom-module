...
import org.openmrs.module.ethiopiaemrcustommodule.api.DrugOrderSyncService;
import org.openmrs.module.ethiopiaemrcustommodule.api.dao.DrugOrderSyncDao;
import org.openmrs.module.ethiopiaemrcustommodule.dto.DrugOrderDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.DrugOrderSyncDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.DrugDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.FrequencyDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.IdentifierDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.OrdererDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.PatientDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.PersonDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.PersonDisplayDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.PreferredNameDTO;
import org.openmrs.module.ethiopiaemrcustommodule.dto.RouteDTO;
...
public class DrugOrderSyncServiceImpl extends BaseOpenmrsService implements DrugOrderSyncService {
	...
	private Date getLastProcessedDate() {
		String dateStr = administrationService
		        .getGlobalProperty(EthiopiaEmrCustomModuleConstants.GP_LAST_PROCESSED_DRUG_ORDER_DATE);
	...
	private void updateLastProcessedDate(Date date) {
		...
		administrationService.setGlobalProperty(EthiopiaEmrCustomModuleConstants.GP_LAST_PROCESSED_DRUG_ORDER_DATE, dateStr);
		log.info("Updated last processed date to: " + dateStr);
	}
	
	private int getBatchSize() {
		String batchSizeStr = administrationService
		        .getGlobalProperty(EthiopiaEmrCustomModuleConstants.GP_DRUG_ORDER_SYNC_BATCH_SIZE);
		if (batchSizeStr == null || batchSizeStr.isEmpty()) {
			return EthiopiaEmrCustomModuleConstants.DEFAULT_BATCH_SIZE;
		}
		try {
	...
	private String getEndpoint() {
		String endpoint = administrationService
		        .getGlobalProperty(EthiopiaEmrCustomModuleConstants.GP_DRUG_ORDER_SYNC_ENDPOINT);
		if (endpoint == null || endpoint.isEmpty()) {
			return EthiopiaEmrCustomModuleConstants.DEFAULT_ENDPOINT;
		}
		return endpoint;
	}
